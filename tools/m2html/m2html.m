...
%  Modified 2026-09 for the baseflow toolbox: dot_exec looks in /usr/local/bin,
...
dot_exec  = '/usr/local/bin/dot'; % mgc added fullpath to dot
% Homebrew on Apple silicon installs GraphViz in /opt/homebrew/bin
if ~isfile(dot_exec) && isfile('/opt/homebrew/bin/dot')
	dot_exec = '/opt/homebrew/bin/dot';
end
%dotbase defined earlier
