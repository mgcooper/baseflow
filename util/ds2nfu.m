...
% % i cannot get the arrow to end on the specified point, even after adding
% plotboxpos, i also confirmed in non-log axis and using the examples below
