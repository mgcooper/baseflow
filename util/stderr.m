...
%STDERR computes the standard error of the mean from the standard deviation
%of the data and the sample size, and applies a critical t-value to compute
...
%--------------------------------------------------------------------------
   ...
   t_c   = tinv(p,N-1);            % t_c has N-1 dof 
