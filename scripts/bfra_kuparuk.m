...
Meta        = bfra_loadmeta(basinname,'archive');
Calm        = bfra_loadcalm(basinname,'archive');
aream2      = Meta.area_m2;
utext       = 'm$^3$ s$^{-1}$';
...
[bhat,tau0]    = bfra_plfitb(tau,'plotfit',true,'bootstrap',true);

% compute uncertainties
TauFit   = bfra_gpfitb(tau,'xmin',tau0,'plot',true,'label',true,'boot',true);
