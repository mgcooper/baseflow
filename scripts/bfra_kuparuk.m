...
% also need to reconcle the method to get ahat in bfra_globalfit with the
% method to get phi in BOTH eventphi and cloudphi 
...
%    GlobalFit = bfra_globalfit_test(K,Events,Fits,Meta,'bootfit', ...
%                         'nreps',20,'plotfit',plotfigs);
...
%----------------------------------------
[Qb,~,~,~,hb,ha] = bfra_baseflow(years,Qcmd,'pctl',pQhat,'show',plotfigs); % cm/d
