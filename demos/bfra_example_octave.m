...
% 
% User note: this is not currently functional.
% 
% Developer note: initial steps to octave compatibility were added but need to
% fix element deletion from datetime arrays in tablicious and/or replace
% datetime with a day vector. This was bfra_example_1.m, renamed to _octave and
% moved out of docs to demos. 
% 
%%% Introduction
...
% _rainfall_.
load('data/dailyflow_octave.mat','T','Q','R');
T = datetime(T);
T2 = datenum(T);
%%
...
H = bfra.hyetograph(T2,Q,R,t1,t2);
