...
%% 
% The toolbox includes a helper function |bfra.getstring| that returns formatted 
% latex strings for plot labels. The |getstring| function assumes the data has 
% the units assumed by functions throughout the toolbox, which serves as a useful 
% reminder when preparing data for analysis. Replace the ylabel created by |bfra.hyetograph| 
% with the formatted string returned by |bfra.getstring|. 

ylabel(bfra.getstring('Q', 'units', true), 'Interpreter', 'latex');
