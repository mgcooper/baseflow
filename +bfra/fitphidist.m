...
h.data = plot(cdfX,cdfY,'o','MarkerFaceColor',c,'MarkerEdgeColor','none', ...
   'Visible',showfit); hold on;
...
if showfit == true
   ...
   % % commented this out to remove dependence on ds2nfu, replaced w/ arrow method
