function [T,Q,R,Info] = eventfinder(t,q,r,varargin)
   ...
   % Find recession events within NaN-separated flow segments.
   [iS, iE] = nonnansegments(q, nmin);
         
   [T, Q, R, Info] = arrayfun(@(s, e) bfra.eventsplitter( ...
      t(s:e), q(s:e), r(s:e), ...
      'nmin', nmin, ...
      'fmax', fmax, ...
      'rmax', rmax, ...
