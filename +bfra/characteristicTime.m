...
%     tc for baseflow to reach 1/e of its initial value. tfunc is an anonymous
%     function for the characteristic time scale. Works for both linear and
%     non-linear models. Note, for linear models, tc is equivalent to
%     characteristic drainage timescale tau. For non-linear models, tc is not
%     equivalent to tau.
% 
%  See also 
% 
