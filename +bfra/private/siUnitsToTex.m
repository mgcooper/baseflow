...
% siUnitsToTex Convert a cellstr or string array of SI units to TeX or LaTeX-formatted strings
%
% Inputs:
%   units: A cellstr array or string array containing standard SI units in the format
%          'm2 s-1' for meters squared per second, '-' for unitless, 'km s-1' for
%          kilometers per second, etc.
%
% Outputs:
%   tex_labels: A cellstr array or string array containing TeX or LaTeX-formatted strings
%               for use as labels in plots.
