...
%   baseflow.open                                - Open package namespace function file in the Editor
...
%   baseflow.stationlist                         - Return list of stations from the baseflow gage database
...
%   baseflow/private.axespixelbox                - The drawn plot box of an axes, in pixels
%   baseflow/private.bootstrapci                 - Calculate confidence intervals by bootstrap resampling residuals
%   baseflow/private.breflinetext                - Text of the b value of a reference line
...
%   baseflow/private.cmd2cms                     - Convert cubic meters / day to cubic meters / second
...
%   baseflow/private.drawarrow                   - Draw an arrow in an axes, with the head on a given point
%   baseflow/private.emptyaxes                   - Return empty axes object
%   baseflow/private.figurevisibility            - Visibility of a figure a caller asked to show
%   baseflow/private.fillnans                    - Fill interior sequences of nan values of length <= fmax
...
%   baseflow/private.fitcts                      - Fit q/dqdt with a finite difference on a constant time step
...
%   baseflow/private.fitNLS_matlab               - Fit -dQ/dt = aQ^b by nonlinear least squares in MATLAB
%   baseflow/private.fitNLS_octave               - Fit -dQ/dt = aQ^b by nonlinear least squares in Octave
...
%   baseflow/private.islabelcolor                - Return true for a value the graphics Color property takes
%   baseflow/private.islineconvex                - True if the first differences of Y trend downward (concave down)
%   baseflow/private.islinehandle                - Return true for a graphics handle of a plotted line
...
%   baseflow/private.islocalmin                  - Return true for local minimum indices of X
...
%   baseflow/private.isodd                       - Check if a number is odd
%   baseflow/private.istablelike                 - Return true if input T is a table or timetable
%   baseflow/private.labelanchor                 - Anchor a reference-line label inside the axes
%   baseflow/private.labelrefline                - Label the reference line -dQ/dt = a*Q^b
%   baseflow/private.latex2tex                   - Convert a LaTeX format string to a TeX interpreter format
%   baseflow/private.loglogangle                 - Drawn angle of a log-log line of slope b
%   baseflow/private.nancorr                     - Compute the sample correlation coefficient for data with NaNs
%   baseflow/private.nanmean                     - Compute the sample mean value, ignoring NaNs
%   baseflow/private.nanmedian                   - Compute the sample median, ignoring NaNs
...
%   baseflow/private.normalizeDataCoordinates    - NORMALIZEDDATACOORDINATES Convert data coordinates to normalized coordinates
%   baseflow/private.nstaruncertainty            - Uncertainty of N* = 1/(4-2b) from the uncertainty of b
%   baseflow/private.olsfit                      - Ordinary least squares linear regression
...
%   baseflow/private.relayoutloglogtext          - Reset the angle of every rotated log-log label
%   baseflow/private.renametimetabletimevar      - Rename the time variable in table T to 'Time'
...
%   baseflow/private.setconstantnan              - Set constant-valued runlengths of RMAX or more nan
...
%   baseflow/private.sizefigure                  - Size a point-cloud figure and keep the position it was given
%   baseflow/private.smooth                      - # Copyright (C) 2013 Erik Kjellson <erikiiofph7@users.sourceforge.net>
%   baseflow/private.smoothflow                  - Smooth measurement noise
%   baseflow/private.smoothnoise                 - Smooth measurement noise
%   baseflow/private.snaploglims                 - Widen log-axis limits to the enclosing decade when it is near
...
%   baseflow/private.struct2varargin             - Convert parser 'Unmatched' to varargin format
...
%   baseflow/private.tocolumn                    - Convert array to column
%   baseflow/private.todatenum                   - Convert input to datenum
%   baseflow/private.withwarnoff                 - Temporarily disable warnings
%   baseflow/private.yorkfit                     - Fit a straight line when both x and y carry measurement errors
%    
%   This file was generated by updatecontents.m on 18 Sep 2026 at 12:28:36.
