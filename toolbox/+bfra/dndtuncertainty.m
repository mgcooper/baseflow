function [sig_dndt, sig_lamda] = dndtuncertainty(T, Qb, Results, Fits, ...
      GlobalFit, opts, varargin)
   ...
   bhat = GlobalFit.b;
   PhiFit = bfra.phifitensemble(Results, Fits, A, D, L, bhat, ...
      lateqtls, earlyqtls, false);
   
   % The sample populations of tau, phi, and Nstar
   [~,~,~,~,G] = bfra.eventtau(Results, Fits, Fits, ...
