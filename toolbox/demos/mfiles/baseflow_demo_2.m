...
opts.globalfit = baseflow.setopts('globalfit', ...
   ...
   'streamlength', L, 'aquiferdepth', D, ...
   'isflat', true, 'plotfits', true);
...
GlobalFit = baseflow.globalfit(FitsTable, EventData, EventFits, opts.globalfit);
...
% The toolbox includes a utility function |baseflow.conversions| for converting 
